<?php
    ...
    curl_setopt_array($covidch, [
        CURLOPT_URL => "https://covid-19-data.p.rapidapi.com/country/code?code=" . $restCountries['alpha2Code'],
        ...
        CURLOPT_HTTPHEADER => [
            ...
            "x-rapidapi-key: 74f44c6470msh9c4a9c3b7cb80b2p177cbejsna5a4ef0fd63a"
        ],
    ]);
